...
import dayjs from 'dayjs';
  ...
  // Top Headings
  const URL=`http://newsapi.org/v2/top-headlines?category=entertainment&country=in&apiKey=${API_KEY}`
  const fetchArticles = () => {
  ...
  const Entertain: React.FunctionComponent = () => {
      ...
      />
        <IonHeader>
          <IonToolbar color="primary">
            ...
            <IonTitle>Entertainment Headlines</IonTitle>
          </IonToolbar>
        </IonHeader>
